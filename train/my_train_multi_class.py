...
parser.add_argument('--loss_weights', default=(1, 1.1))  #cost sensitive learning, weighted cross entropy
...
parser.add_argument('--save_model_dir', default='/tmp2/2021_7_31_AMD/multi_class/')

args = parser.parse_args()

if 'CUDA_DEVICE_ORDER' in args:
...
loader_train = DataLoader(ds_train, batch_size=args.batch_size_train,
                          pin_memory=True, num_workers=args.num_workers)  #sampler=sampler,
